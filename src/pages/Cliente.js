...
import medicinal2 from "../assets/images/cana.jpg"
const Cliente = () => {
  return (
    <>
            ...
            <section className="col-lg-12 col-xl-11">
              <section className="card text-black">
                <section className="card-body p-md-0">
                  <section className="alert success text-center" role="alert">
                    Registrar Cliente
                  </section>
                      ...
                      <form className="mx-1 mx-md-4">
                        ...
                        <section className="d-flex flex-row align-items-center mb-4">
                          <section className="form-outline flex-fill mb-0">
                            <input type="text" id="form3Example1c" className="form-control" placeholder="Nombre Cliente" />
                          </section>
                        </section>

                        <section className="d-flex flex-row align-items-center mb-4">
                          <section className="form-outline flex-fill mb-0">
                            <input type="text" placeholder="Documento" id="form3Example3c" className="form-control" />
                          </section>
                        </section>
                        <section className="d-flex flex-row align-items-center mb-4">
                          <section className="form-outline flex-fill mb-0">
                        ...
                        <section className="d-flex flex-row align-items-center mb-4">
                          <section className="form-outline flex-fill mb-0">
                            <input type="text" placeholder="Barrio" id="form3Example3c" className="form-control" />
                          </section>
                        </section>
                        <section className="d-flex flex-row align-items-center mb-4">
                          <section className="form-outline flex-fill mb-0">
